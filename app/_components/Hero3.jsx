    ...
    <div className="h-56 sm:h-64 xl:h-80 2xl:h-96 mt-10 mb-10">
      <Carousel pauseOnHover>
        <div className="relative w-full h-full">
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="bg-black bg-opacity-70 text-center p-4 rounded">
              <span className="text-white text-2xl font-bold block">Professional Electrical Services</span>
        ...
        <div className="relative w-full h-full">
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="bg-black bg-opacity-70 text-center p-4 rounded">
              <span className="text-white text-2xl font-bold block">Expert Plumbing Services</span>
        ...
        <div className="relative w-full h-full">
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="bg-black bg-opacity-70 text-center p-4 rounded">
              <span className="text-white text-2xl font-bold block">Professional Cleaning Services</span>
        ...
        <div className="relative w-full h-full">
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="bg-black bg-opacity-70 text-center p-4 rounded">
              <span className="text-white text-2xl font-bold block">Professional Painting Services</span>
        ...
        <div className="relative w-full h-full">
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="bg-black bg-opacity-70 text-center p-4 rounded">
              <span className="text-white text-2xl font-bold block">Reliable Security Services</span>
